...
import { User } from '../../model/modelModule';
import { ErrorDialogComponent } from '../componentModule';
import { MatDialog, MatDialogModule } from '@angular/material/dialog';

@Component({
  selector: 'lib-default-registration',
  standalone: true,
  imports: [
    CommonModule, 
    ReactiveFormsModule, 
  ...
  templateUrl: './default-registration.component.html',
  styleUrl: './default-registration.component.scss'
})
export class DefaultRegistrationComponent implements OnInit {
